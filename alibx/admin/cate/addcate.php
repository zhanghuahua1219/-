          ...
          <form action="addcate_deal.php" method="post">
            ...
            <div class="form-group">
             ...
             <div class="form-group">
               ...
               <input id="slug" value="1" name="status" type="radio" > 启用
               <input id="slug" value="2" name="status" type="radio" > 禁用  
            </div>
             <div class="form-group">
               <label for="slug">是否显示</label>
               <input id="slug" value="1" name="show" type="radio" > 显示
               <input id="slug" value="2" name="show" type="radio" > 不显示 
            </div>
            <div class="form-group">
              
               <input id="slug" value="添加"  type="submit" class="btn btn-primary"> 
